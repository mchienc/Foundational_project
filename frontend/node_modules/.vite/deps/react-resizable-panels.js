...
var pe;
function De() {
  return pe === void 0 && (pe = false, typeof window < "u" && (window.navigator.userAgent.includes("Chrome") || window.navigator.userAgent.includes("Firefox")) && (pe = true)), pe;
}
function It({
  cursorFlags: e,
  groups: t,
  ...
  switch (t.state) {
    case "active":
      te({
        cursorFlags: 0,
        state: "inactive"
      }), t.hitRegions.length > 0 && (Pe(e), o = true, t.hitRegions.forEach((i) => {
        if (!n.has(i.group))
          return;
        const s = H(i.group.id, true);
        j(i.group, s, {
...
function at({
  ...
  const n = () => {
    ...
    if (f && r < p && (z || l.slice(0, S).every((h, y) => {
      const b = m[y];
      return (b == null ? void 0 : b.collapsible) && D(b.collapsedSize, c[b.panelId]);
    }))) {
...
function B(e, t) {
  const n = he(e), o = H(n.id, true), i = n.separators.find(
    (m) => m.element === e
  );
...
function $e(e) {
  ...
  if (!n.disabled)
    switch (e.key) {
      ...
      case "Enter": {
        e.preventDefault();
        const o = he(t), i = H(o.id, true), { derivedPanelConstraints: s, layout: u, separatorToPanels: a } = i, r = o.separators.find(
          (p) => p.element === t
        );
    ...
    case "active": {
      ...
      for (const o of t.hitRegions)
        if (o.separator) {
          ...
          i.isConnected && !((_a = i.hasPointerCapture) == null ? void 0 : _a.call(i, e.pointerId)) && ((_b = i.setPointerCapture) == null ? void 0 : _b.call(i, e.pointerId));
        }
      ut({
        document: e.currentTarget,
        event: e,
...
function Vt(e, t) {
  return e.length !== t.length ? false : e.every((n, o) => Ht(n, t[o]));
}
function Ut({
  group: e,
  nextGroupSize: t,
...
function qt({
  ...
  const z = (0, import_react.useRef)({
    ...
    K(z.current.onLayoutChange, x) || (z.current.onLayoutChange = x, r == null ? void 0 : r(x));
  }), d = re(
    (x, P) => {
      K(z.current.onLayoutChanged, x) || (z.current.onLayoutChanged = x, l == null ? void 0 : l(x, { isUserInteraction: P }));
    }
...
function an({
  ...
  const s = n !== void 0, u = "id" in i ? i.id : i.groupId, a = me(u, n ?? []), r = (0, import_react.useSyncExternalStore)(
    Jt,
    () => o.getItem(a),
    () => o.getItem(a)
...
function Qt({
  ...
  const f = !!r, d = Ce(r), h = Ee({
    disabled: s
  }), y = (0, import_react.useRef)(null), b = Re(y, u), {
    getPanelStyles: v,
    id: g,
    orientation: w,
    registerPanel: E,
...
function nn({
  ...
  const r = Ce(s), l = Ee({
    disabled: n,
    disableDoubleClick: o
  }), [c, m] = (0, import_react.useState)({}), [p, S] = (0, import_react.useState)("inactive"), [z, f] = (0, import_react.useState)(false), d = (0, import_react.useRef)(null), h = Re(d, i), {
    disableCursor: y,
    id: b,
    orientation: v,
    registerSeparator: g,
